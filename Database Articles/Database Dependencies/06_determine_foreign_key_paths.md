...
The following illustrates a foreign key path for the `dbo.Orders` table. From this output, we can identify all objects that the table depends on via foreign keys, as well as the dependencies of those related tables.
...
| 2  | Application.People              | Sales.Orders  ➡️  Application.People                                    | 1     |
| 3  | Application.Cities              | Sales.Orders  ➡️  Application.People ➡️ Application.Cities              | 2     |
| 4  | Application.Countries           | Sales.Orders  ➡️  Application.People ➡️ Application.Countries           | 2     |
| 5  | Application.DeliveryMethods     | Sales.Orders  ➡️  Application.People ➡️ Application.DeliveryMethods     | 2     |
| 6  | Application.PaymentMethods      | Sales.Orders  ➡️  Application.People ➡️ Application.PaymentMethods      | 2     |
| 7  | Application.StateProvinces      | Sales.Orders  ➡️  Application.People ➡️ Application.StateProvinces      | 2     |
| 8  | Application.SystemParameters    | Sales.Orders  ➡️  Application.People ➡️ Application.SystemParameters    | 2     |
| 9  | Application.TransactionTypes    | Sales.Orders  ➡️  Application.People ➡️ Application.TransactionTypes    | 2     |
| 10 | Purchasing.PurchaseOrderLines   | Sales.Orders  ➡️  Application.People ➡️ Purchasing.PurchaseOrderLines   | 2     |
| 11 | Purchasing.PurchaseOrders       | Sales.Orders  ➡️  Application.People ➡️ Purchasing.PurchaseOrders       | 2     |
| 12 | Purchasing.SupplierCategories   | Sales.Orders  ➡️  Application.People ➡️ Purchasing.SupplierCategories   | 2     |
| 13 | Purchasing.Suppliers            | Sales.Orders  ➡️  Application.People ➡️ Purchasing.Suppliers            | 2     |
| 14 | Purchasing.SupplierTransactions | Sales.Orders  ➡️  Application.People ➡️ Purchasing.SupplierTransactions | 2     |
| 15 | Sales.BuyingGroups              | Sales.Orders  ➡️  Application.People ➡️ Sales.BuyingGroups              | 2     |
| 16 | Sales.CustomerCategories        | Sales.Orders  ➡️  Application.People ➡️ Sales.CustomerCategories        | 2     |
| 17 | Sales.CustomerTransactions      | Sales.Orders  ➡️  Application.People ➡️ Sales.CustomerTransactions      | 2     |
| 18 | Sales.InvoiceLines              | Sales.Orders  ➡️  Application.People ➡️ Sales.InvoiceLines              | 2     |
| 19 | Sales.SpecialDeals              | Sales.Orders  ➡️  Application.People ➡️ Sales.SpecialDeals              | 2     |
| 20 | Warehouse.Colors                | Sales.Orders  ➡️  Application.People ➡️ Warehouse.Colors                | 2     |
| 21 | Warehouse.PackageTypes          | Sales.Orders  ➡️  Application.People ➡️ Warehouse.PackageTypes          | 2     |
| 22 | Warehouse.StockGroups           | Sales.Orders  ➡️  Application.People ➡️ Warehouse.StockGroups           | 2     |
| 23 | Warehouse.StockItemHoldings     | Sales.Orders  ➡️  Application.People ➡️ Warehouse.StockItemHoldings     | 2     |
| 24 | Warehouse.StockItems            | Sales.Orders  ➡️  Application.People ➡️ Warehouse.StockItems            | 2     |
| 25 | Warehouse.StockItemStockGroups  | Sales.Orders  ➡️  Application.People ➡️ Warehouse.StockItemStockGroups  | 2     |
| 26 | Warehouse.StockItemTransactions | Sales.Orders  ➡️  Application.People ➡️ Warehouse.StockItemTransactions | 2     |
| 27 | Sales.Customers                 | Sales.Orders  ➡️  Sales.Customers                                       | 1     |
| 28 | Sales.Invoices                  | Sales.Orders ➡️ Sales.Invoices                                          | 1     |
| 29 | Sales.OrderLines                | Sales.Orders ➡️ Sales.OrderLines                                        | 1     |

----

We can also determine reverse dependencies.  In this example, we identify all objects that have a foreign key path to the `dbo.Orders` table.

| ID | TableName                       | Path                                                               | Depth |
|----|---------------------------------|--------------------------------------------------------------------|-------|
| 1  | Sales.Orders                    | Sales.Orders                                                       | 0     |
| 2  | Sales.Invoices                  | Sales.Invoices ⬅️ Sales.Orders                                     | 1    |
| 3  | Sales.OrderLines                | Sales.OrderLines ⬅️ Sales.Orders                                   | 1    |
| 4  | Sales.CustomerTransactions      | Sales.CustomerTransactions ⬅️ Sales.Invoices ⬅️ Sales.Orders      | 2     |
| 5  | Sales.InvoiceLines              | Sales.InvoiceLines ⬅️ Sales.Invoices ⬅️ Sales.Orders              | 2     |
| 6  | Warehouse.StockItemTransactions | Warehouse.StockItemTransactions ⬅️ Sales.Invoices ⬅️ Sales.Orders | 2     |
...
* `##temp_sp_determine_fk_paths` – Traces downstream foreign key dependencies (what the object depends on)
* `##temp_sp_determine_fk_paths_reverse` – Traces upstream foreign key dependencies (what depends on the object)
