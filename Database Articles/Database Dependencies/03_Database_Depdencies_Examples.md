...
1. [Cross-Databases and Cross-Schema Dependencies](03_database_dependencies_examples.md#id-01.-cross-databases-and-cross-schema-dependencies)
2. [Cross Schema Dependencies](03_database_dependencies_examples.md#id-02.-cross-schema-dependencies)
3. [Invalid Stored Procedures](03_database_dependencies_examples.md#id-03.-invalid-stored-procedures)
4. [Numbered Stored Procedures](03_database_dependencies_examples.md#id-04.-numbered-stored-procedures)
5. [Ambiguous References](03_database_dependencies_examples.md#id-05.-ambiguous-references)
6. [Part Naming Conventions](03_database_dependencies_examples.md#id-06.-part-naming-conventions)
7. [Part Naming Conventions - Caller Dependent](03_database_dependencies_examples.md#id-07.-part-naming-conventions-caller-dependent)
8. [Dropping Objects](03_database_dependencies_examples.md#id-08.-dropping-objects)
9. [Dropping Objects Then Recreating](03_database_dependencies_examples.md#id-09.-dropping-objects-then-recreating)
10. [Self-Referencing Objects](03_database_dependencies_examples.md#id-10.-self-referencing-objects)
11. [Object Aliases](03_database_dependencies_examples.md#id-11.-object-aliases)
12. [Schemabindings](03_database_dependencies_examples.md#id-12.-schemabindings)
13. [Synonyms](03_database_dependencies_examples.md#id-13.-synonyms)
14. [Triggers - DML](03_database_dependencies_examples.md#id-14.-triggers-dml)
15. [Triggers - DDL Database Level](03_database_dependencies_examples.md#id-15.-triggers-ddl-database-level)
16. [Triggers - DDL Server Level - Table Insert](03_database_dependencies_examples.md#id-16.-triggers-ddl-server-level-table-insert)
17. [Partition Functions](03_database_dependencies_examples.md#id-17.-partition-functions)
18. [Defaults and Rules](03_database_dependencies_examples.md#id-18.-defaults-and-rules)
19. [Contracts, Queues, and Message Types](03_database_dependencies_examples.md#id-19.-contracts-queues-and-message-types)
20. [Sequences](03_database_dependencies_examples.md#id-20.-sequences)
21. [User Defined Data Types](03_database_dependencies_examples.md#id-21.-user-defined-data-types)
22. [User Defined Table Types](03_database_dependencies_examples.md#id-22.-user-defined-table-types)
23. [Check Constraints](03_database_dependencies_examples.md#id-23.-check-constraints)
24. [Foreign Key Constraints](03_database_dependencies_examples.md#id-24.-foreign-key-constraints)
25. [Computed Columns](03_database_dependencies_examples.md#id-25.-computed-columns)
26. [Masked Functions](03_database_dependencies_examples.md#id-26.-masked-functions)
27. [Indexes - Table](03_database_dependencies_examples.md#id-27.-indexes-table)
28. [Indexes - Filtered NonClustered](03_database_dependencies_examples.md#id-28.-indexes-filtered-nonclustered)
29. [Indexes - Filtered XML](03_database_dependencies_examples.md#id-29.-indexes-filtered-xml)
30. [Statistics - Filtered](03_database_dependencies_examples.md#id-30.-statistics-filtered)
31. [XML Schema Collection](03_database_dependencies_examples.md#id-31.-xml-schema-collection)
32. [XML Methods](03_database_dependencies_examples.md#id-32.-xml-methods)
33. [Feature Installed Procedures](03_database_dependencies_examples.md#id-33.-feature-installed-procedures)
