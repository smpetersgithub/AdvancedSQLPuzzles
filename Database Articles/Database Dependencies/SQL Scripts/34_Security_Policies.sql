...
DROP SECURITY POLICY IF EXISTS dbo.security_policy_example_35;
DROP TABLE IF EXISTS dbo.tbl_example_35;
DROP FUNCTION IF EXISTS dbo.fn_example_35;
GO
...
CREATE FUNCTION dbo.fn_example_35 (@Salesperson SYSNAME)
RETURNS TABLE
WITH SCHEMABINDING
AS
...
CREATE SECURITY POLICY dbo.security_policy_example_35
ADD FILTER PREDICATE dbo.fn_example_35(Salesperson)
ON dbo.tbl_example_35
WITH (STATE = ON);
GO
...
SELECT  '03', c.type, @@SERVERNAME, DB_NAME(), SCHEMA_NAME(c.schema_id), c.name, a.referencing_id, a.referencing_minor_id, a.referencing_class, a.referencing_class_desc, a.is_schema_bound_reference, a.referenced_class, a.referenced_class_desc, a.referenced_server_name, a.referenced_database_name, a.referenced_schema_name, a.referenced_entity_name, b.type AS referenced_object_type, a.referenced_id, a.referenced_minor_id, a.is_caller_dependent, a.is_ambiguous, c.is_ms_shipped, b.is_ms_shipped, CASE WHEN a.referencing_id = a.referenced_id THEN 1 ELSE 0 END
