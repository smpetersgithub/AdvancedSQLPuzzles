...
DROP TABLE IF EXISTS  dbo.tbl_example_13;
DROP SYNONYM IF EXISTS dbo.syn_invalid_example_13;
DROP SYNONYM IF EXISTS dbo.syn_example_13;
DROP VIEW IF EXISTS dbo.vw_example_13;
DROP PROCEDURE IF EXISTS dbo.sp_example_13;
GO
---------------------------------------------
---------------------------------------------
---------------------------------------------
