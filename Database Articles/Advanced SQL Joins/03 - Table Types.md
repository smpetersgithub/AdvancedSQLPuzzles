...
A subquery can be either correlated or noncorrelated and can appear in several forms. Correlated subqueries can be used with `CROSS APPLY`, `OUTER APPLY`, `[NOT] EXISTS`, and `[NOT] IN`. These techniques will be covered later in this documentation.
