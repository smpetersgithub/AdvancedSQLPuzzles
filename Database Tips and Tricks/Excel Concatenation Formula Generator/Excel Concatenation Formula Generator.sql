...
Important: Keep in mind that the data types generated by the formula will be in String format.
...
--Create an #Alphabet table to determine number of columns in Excel file
...
--Note, current max column in Excel is XFD
--18,278 rows
